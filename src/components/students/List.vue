 ...
 <div>
    <div class="bg-orange-600 p-4 grid grid-cols-9">
        <div class="col-span-6 md:col-span-8">
            <h1 class="text-3xl font-bold text-center text-white">Student List</h1>
        </div>
    ...
    <table class="table-auto w-full">
       ...
       <tbody class="text-center">
            <tr>
                <td class="py-2">1</td>
                <td class="py-2">Jhon</td>
                <td class="py-2">Jhon@gmail.com</td>
                <td class="py-2 flex gap-4 justify-center cursor-pointer">
                    <RouterLink :to="{name:'views', params:{id: 1}}">
                        <EyeIcon class="text-blue-500 h-6 w-6 inline" />
                    </RouterLink>
                    <RouterLink :to="{name:'edit', params:{id: 1}}">
                      <PencilIcon class="text-emerald-500 h-6 w-6 inline" />
                    </RouterLink>
